...
START TRANSACTION;
USE `EasyGoDB`;
INSERT INTO `EasyGoDB`.`gomaps` (`owner_login`, `name`, `tags`, `map_attributes`, `is_private`) VALUES ('olhaR', 'ATMs', 'ATMs', 'look for this ATMs', true);
INSERT INTO `EasyGoDB`.`gomaps` (`owner_login`, `name`, `tags`, `map_attributes`, `is_private`) VALUES ('olehG', 'Coffee', 'Cup', 'look for this coffee', true);
INSERT INTO `EasyGoDB`.`gomaps` (`owner_login`, `name`, `tags`, `map_attributes`, `is_private`) VALUES ('aleksS', 'WaterAutomats', 'Water', 'look for this water', false);
...
START TRANSACTION;
USE `EasyGoDB`;
INSERT INTO `EasyGoDB`.`points` (`x`, `y`, `name`, `map_id`, `attribute_values`) VALUES (-24, 6, 'Privat', 3, 'ATM');
INSERT INTO `EasyGoDB`.`points` (`x`, `y`, `name`, `map_id`, `attribute_values`) VALUES ( -15, 3, 'GasBank', 3, 'ATMGasBank');
INSERT INTO `EasyGoDB`.`points` ( `x`, `y`, `name`, `map_id`, `attribute_values`) VALUES ( 12, 8, 'UniCredit', 3, 'ATMUniCredit');
INSERT INTO `EasyGoDB`.`points` ( `x`, `y`, `name`, `map_id`, `attribute_values`) VALUES (6, -3, 'UniCredit', 3, 'ATMUniCredit2');
INSERT INTO `EasyGoDB`.`points` ( `x`, `y`, `name`, `map_id`, `attribute_values`) VALUES ( -20, 21, 'GasBank', 3, 'ATMGasBank');
INSERT INTO `EasyGoDB`.`points` (`x`, `y`, `name`, `map_id`, `attribute_values`) VALUES (3, -1, 'Privat', 3, 'ATMPrivat');
INSERT INTO `EasyGoDB`.`points` ( `x`, `y`, `name`, `map_id`, `attribute_values`) VALUES ( 0, 13, 'Privat', 3, 'ATMPrivat');
INSERT INTO `EasyGoDB`.`points` ( `x`, `y`, `name`, `map_id`, `attribute_values`) VALUES ( -23, 14, 'Privat', 3, 'ATMPrivat');
