...
CREATE TABLE IF NOT EXISTS `EasyGoDB`.`points` (
  `pointi_id` int not null primary key auto_increment,
  `x` FLOAT NOT NULL,
  `y` FLOAT NOT NULL,
...
START TRANSACTION;
USE `EasyGoDB`;
INSERT INTO `EasyGoDB`.`points` (`pointi_id`, `x`, `y`, `name`, `map_id`, `attribute_values`) VALUES ('0', 21331.3, 12321.2, 'Privat', '0', 'ATM');
